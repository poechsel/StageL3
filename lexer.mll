...
rule token = parse    (* la "fonction" aussi s'appelle token .. *)
  ...
  | (digit_sequence? as a) ((("e" | "E") as exp_word) (['+''-'] as sgn) (digit_sequence as dgts)) (['f' 'F' 'l' 'L']? as suffix)
    { 
...
DEC_CST_FRAC(num_a, num_b, exp, suffix)
  ...
  | (digit_sequence? as a) ('.' (digit_sequence? as b))  ((("e" | "E") as exp_word) (['+''-'] as sgn) (digit_sequence as dgts))? (['f' 'F' 'l' 'L']? as suffix)
    { 
let num_a = Num.num_of_string (if a = "" then "0" else a) in
...
DEC_CST_FRAC(num_a, num_b, exp, suffix)
  ...
  | ("0x" | "0X") (hexadecimal_digit_sequence? as a) ('.' (hexadecimal_digit_sequence? as b))?  ((("p" | "P") as exp_word) (['+''-'] as sgn) (hexadecimal_digit_sequence as dgts)) (['f' 'F' 'l' 'L']? as suffix)
    { 
